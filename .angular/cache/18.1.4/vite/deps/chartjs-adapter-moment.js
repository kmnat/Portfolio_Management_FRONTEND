...
adapters._date.override(typeof import_moment.default === "function" ? {
  _id: "moment",
  // DEBUG ONLY
  formats: function() {
    return FORMATS;
  ...
  parse: function(value, format) {
    if (typeof value === "string" && typeof format === "string") {
      value = (0, import_moment.default)(value, format);
    } else if (!(value instanceof import_moment.default)) {
      value = (0, import_moment.default)(value);
    }
    return value.isValid() ? value.valueOf() : null;
  },
  format: function(time, format) {
    return (0, import_moment.default)(time).format(format);
  },
  add: function(time, amount, unit) {
    return (0, import_moment.default)(time).add(amount, unit).valueOf();
  },
  diff: function(max, min, unit) {
    return (0, import_moment.default)(max).diff((0, import_moment.default)(min), unit);
  },
  startOf: function(time, unit, weekday) {
    time = (0, import_moment.default)(time);
    if (unit === "isoWeek") {
  ...
  endOf: function(time, unit) {
    return (0, import_moment.default)(time).endOf(unit).valueOf();
  }
} : {});
